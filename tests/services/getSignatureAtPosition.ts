...
describe('getSignatureAtPosition', function () {
    ...
    var fileName = 'services/testCode/getSignatureAtPositionTest.ts';
    var fileName2 = 'services/testCode/getSignatureAtPositionTestEOF.ts';
    ...
    function singatureAtPos(line: number, col: number): Services.SignatureInfo {
        return ls.languageService.getSignatureAtPosition(fileName, typescriptLS.lineColToPosition(fileName, line, col));
    }

    function singatureAtPos2(line: number, col: number): Services.SignatureInfo {
        return ls.languageService.getSignatureAtPosition(fileName2, typescriptLS.lineColToPosition(fileName2, line, col));
    }
    ...
    describe('Get signatures from position', function () {
        ...
        it("Construct expression", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 3, 22), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 3, 29), actual.closeParenLimChar);
            assert.equal(2, actual.parameters.length);
            assert.equal(typescriptLS.lineColToPosition(fileName, 3, 23), actual.parameters[0].minChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 3, 25), actual.parameters[0].limChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 3, 27), actual.parameters[1].minChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 3, 28), actual.parameters[1].limChar);
        ...
        it("Call expression", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 7, 7), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 7, 9), actual.closeParenLimChar);
        ...
        it("Overloaded function", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 11, 11), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 11, 13), actual.closeParenLimChar);
            assert.equal(0, actual.parameters.length);
        ...
        it("Overloaded function 2", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 12, 11), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 12, 15), actual.closeParenLimChar);
            assert.equal(1, actual.parameters.length);
            assert.equal(typescriptLS.lineColToPosition(fileName, 12, 12), actual.parameters[0].minChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 12, 14), actual.parameters[0].limChar);
        ...
        it("Overloaded construct", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 15, 24), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 15, 26), actual.closeParenLimChar);
        ...
        it("Overloaded construct: call second overload", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 16, 24), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 16, 28), actual.closeParenLimChar);

            assert.equal(1, actual.parameters.length);
            assert.equal(typescriptLS.lineColToPosition(fileName, 16, 25), actual.parameters[0].minChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 16, 27), actual.parameters[0].limChar);
        ...
        it("Incomplete call (with statements after the incomple call)", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 31, 13), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 34, 10), actual.closeParenLimChar);
        ...
        it("Incomplete call 2 (inside another incomplete call)", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 32, 13), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 34, 10), actual.closeParenLimChar);
        ...
        it("Incomplete call 3 (close curly after incomplete call)", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 33, 13), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 34, 10), actual.closeParenLimChar);
        ...
        it("Calling off a parameter function", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 44, 21), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 44, 28), actual.closeParenLimChar);
        ...
        it("Calling off a returned function", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 53, 14), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 53, 21), actual.closeParenLimChar);
        ...
        it("Calling off a object literal property function", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName, 58, 8), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName, 58, 15), actual.closeParenLimChar);
    ...
    describe('Get signatures at EOF', function () {
        it("Function signature at EOF", function () {
            ...
            assert.equal(typescriptLS.lineColToPosition(fileName2, 5, 4), actual.openParenMinChar);
            assert.equal(typescriptLS.lineColToPosition(fileName2, 5, 5), actual.closeParenLimChar);
