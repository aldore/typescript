...
describe('getSmartIndentAtLineNumber', function() {
    ...
    var fileName = 'services/testCode/getSmartIndentAtLineNumber.ts';
    var fileName2 = 'services/testCode/getSmartIndentAtLineNumber2.ts';
    var fileName3 = 'services/testCode/getSmartIndentAtLineNumber3.ts';
