...
describe('getFormattingEditsAfterKeystroke', function() {
    ...
    function getFormattingEditsAfterKeystroke(sourceFileName:string, line:number, column:number, key:string): void {
        var baselineFileName = "services/testCode/formatAfterKeystroke/" + sourceFileName + "BaseLine.ts";
        sourceFileName = "services/testCode/formatAfterKeystroke/" + sourceFileName + ".ts";
