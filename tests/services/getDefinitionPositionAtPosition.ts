...
describe('getDefinitionPositionAtPosition', function() {
    ...
    var fileName = 'services/testCode/getDefinitionsAtPosition.ts';
    var fileName2 = 'services/testCode/getDefinitionsAtPosition2.ts';
    var fileName3 = 'services/testCode/getDefinitionsAtPosition3.ts';
