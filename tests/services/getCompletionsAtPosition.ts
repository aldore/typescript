...
describe('getCompletionsAtPosition', function () {
    ...
    var fileName = 'services/testCode/getCompletionsAtPosition1.ts';
    var fileName2 = 'services/testCode/getCompletionsAtPosition2.ts';
    var fileName3 = 'services/testCode/getCompletionsAtPosition3.ts';
    var fileName4 = 'services/testCode/getCompletionsAtPosition4.ts';
    var fileName5 = 'services/testCode/getCompletionsAtPosition5.ts';
    var fileName6 = 'services/testCode/getCompletionsAtPosition6.ts';
    var fileName7 = 'services/testCode/getCompletionsAtPosition7.ts';
    var fileName8 = 'services/testCode/getCompletionsAtPosition8.ts';
    var fileName9 = 'services/testCode/getCompletionsAtPosition9.ts';
    var fileName10 = 'services/testCode/getCompletionsAtPosition10.ts';
    var fileNameBugFixes = 'services/testCode/getCompletionsAtPositionBugFixes.ts';
