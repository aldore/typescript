...
describe('importedJavaScriptFormatting - formatting rules', function() {
    var documentTests: DocumentTestJson[] = eval('[' + IO.readFile(Harness.userSpecifiedroot + 'tests/services/documentFormattingTests.json') + ']');

    var outputFile = 'diff-1.html';
    IO.writeFile(outputFile, IO.readFile(Harness.userSpecifiedroot + 'tests/services/formatDiffTemplate.html'));
...
describe('importedJavaScriptFormatting - formatting operations', function() {
    ...
    var operationsTests: FormatOperationTestJson[] = eval('[' + IO.readFile(Harness.userSpecifiedroot + 'tests/services/ruleFormattingTests.json') + ']');
