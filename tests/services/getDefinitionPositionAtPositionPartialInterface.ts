...
describe('getDefinitionPositionAtPositionPartialInterface', function() {
    ...
    var fileName = 'services/testCode/getDefinitionsAtPositionPartialInterface1.ts';
    var fileName2 = 'services/testCode/getDefinitionsAtPositionPartialInterface2.ts';
