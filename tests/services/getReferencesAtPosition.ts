...
describe('getReferencesAtPosition', function() {
    ...
    var fileName1 = 'services/testCode/getReferencesAtPositionTest.ts';
    var fileName2 = 'services/testCode/getReferencesAtPositionTest2.ts';
    var fileName3 = 'services/testCode/getReferencesAtPositionTest3.ts';
